...
* 시간: 오후 7시 ~ 9시 50분
* 장소:<br>
  <span class="venue-change-notice">🐧 장소 변경</span><br>
  서울시 서초구 강남대로53길 8, 마이워크스페이스타워 B2, 한국컨퍼런스센터 (강남역 5번 출구에서 도보 2분)<br>
  ~~서울시 강남구 테헤란로1길 10 세경빌딩 6층 공간더하기(강남역 11번 출구 근처)~~
